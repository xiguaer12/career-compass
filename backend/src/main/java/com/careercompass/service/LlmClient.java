...
public class LlmClient {
  ...
  public AiReport generateReport(
    ...
    return new AiReport(
        ...
        fallback.scores() == null ? List.of() : fallback.scores(),
        fallback.dimensions() == null ? List.of() : fallback.dimensions(),
        reportText,
        stringValue(fallback.studentProfile(), ""),
        summary,
        fallback.risks() == null ? List.of() : fallback.risks(),
        fallback.alternatives() == null ? List.of() : fallback.alternatives(),
        fallback.plan() == null ? List.of() : fallback.plan(),
        fallback.resources() == null ? List.of() : fallback.resources(),
        disclaimer,
